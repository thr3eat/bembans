...
“”,
“**Başvuru Formatı:**”,
“`", "Roblox İsmi:", "Discord İsmi:", "Discord ID:", "Ban Sebebi (Dürüst şekilde yazın, zaten herkesin ban sebebi kayıtlı):", "Nereden Ban Yediniz:", "Ban Tarihi:", "`”,
“”,
...
.setDescription(
[
`**Kullanıcı:** ${ban.user.tag} (\`${userId}`)`, `**Ban ID:** #${banId}`, "", `Ban mesajı göndermek için ana sunucuda şu komutu kullanın:`, ``/banmesaj ban_id:${banId}``,
].join(”\n”)
)
.setTimestamp();
